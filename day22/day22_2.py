...
class Virus():
    ...
    def _change_state(self):
        if matrix[self.pos[0]][self.pos[1]] == 0:
            matrix[self.pos[0]][self.pos[1]] = 2
        elif matrix[self.pos[0]][self.pos[1]] == 1:
            matrix[self.pos[0]][self.pos[1]] = 3
        elif matrix[self.pos[0]][self.pos[1]] == 2:
...
with open('./input.txt', 'r') as inputFile:
    ...
    matrix = np.zeros((1000000,1000000))
    ...
    print("Parte 2: " + str(virus.infections))
